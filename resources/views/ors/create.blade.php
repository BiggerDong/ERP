        ...
        <div class="row">
            <div class="col-md-9 col-md-offset-1" style="margin-top: 50px;">
                <div class="row" style="margin-bottom: -20px;">
                    <div class="col-md-2" >
                        <a class="btn btn-sm btn-primary s-all" href="/bills/or">所有采购订单</a>
                    </div>
                    <div class="col-md-3 pull-right" style="margin-bottom: -20px;">
                        <form action="/suppliers/search">
                            <div class="form-group">
                                <input type="text" id="b-search" class="form-control" name="bid" placeholder="搜索采购订单编号"
            ...
            <div class="col-md-9 col-md-offset-1">
                <form action="/bills/or" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="row" style="margin-top: 20px;">
                        ...
                        <div class="pull-right" style="margin-right: -25px;">
                            <div class="form-group">
                                <label for="s-number" class="control-label">采购订单编号</label>
                                <input type="text" readonly value="OR{{ $bill_id }}" name="bid"
                        ...
                        <div class="pull-right">
                            <div class="form-group">
                                <label for="s-number" class="control-label">供应商</label>
                                <st-form-supplier-select style="margin-right: 17px;margin-left: 15px;"></st-form-supplier-select>
                            </div>
                        </div>
                    </div>
                    <br>
