        ...
        <div class="row">
            <div class="col-md-9 col-md-offset-1" style="margin-top: 50px;">
                <div class="row" style="margin-bottom: -20px;">
                    <div class="col-md-2">
                        <a class="btn btn-sm btn-primary s-all" href="/bills">所有缺货单</a>
                    </div>
            ...
            <div class="col-md-9 col-md-offset-1">
                <form action="/suppliers" method="post">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        ...
                        <div class="pull-right" style="margin-right: -25px;">
                            <div class="form-group">
                                ...
                                <input type="text" readonly value="ST{{ $bill_id }}"
                    ...
                    <br>
                    <div class="row" id="other-stform-1" style="margin-top: 20px;display: none;">
                        <div class="form-group">
                            <label for="b-mid" class="col-md-2 control-label">物料编号</label>
                            <div class="col-md-3" style="margin-top: -8px;margin-left: -72px;">
                                <st-form-select></st-form-select>
                    ...
                    <br>
                    <div class="row" id="other-stform-2" style="margin-top: 20px;display: none;">
                        <div class="form-group">
                            <label for="b-mid" class="col-md-2 control-label">物料编号</label>
                            <div class="col-md-3" style="margin-top: -8px;margin-left: -72px;">
                                <st-form-select></st-form-select>
