        ...
        <div class="row">
            <div class="col-md-9 col-md-offset-1" style="margin-top: 50px;">
                <div class="row" style="margin-bottom: -20px;">
                    <div class="col-md-2" >
                        <a class="btn btn-sm btn-primary s-all" href="/bills/ai">所有收货单</a>
                    </div>
                    <div class="col-md-3 pull-right" style="margin-bottom: -20px;">
                        <form action="/suppliers/search">
                            <div class="form-group">
                                <input type="text" id="b-search" class="form-control" name="bid" placeholder="搜索收货单编号"
            ...
            <div class="col-md-9 col-md-offset-1">
                <form action="/bills/ai" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="row" style="margin-top: 20px;">
                        ...
                        <div class="pull-right" style="margin-right: -25px;">
                            <div class="form-group">
                                <label for="s-number" class="control-label">收货单编号</label>
                                <input type="text" readonly value="AI{{ $bill_id }}" name="bid"
