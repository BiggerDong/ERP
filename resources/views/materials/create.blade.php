            ...
            <form action="/materials" method="post">
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-3" style="margin-top: -8px;margin-left: -60px;">
                            <input type="text" class="form-control" name="mid" id="m-number" placeholder="物料编号" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3" style="margin-top: -23px;margin-left: -60px;">
                            <input type="text" class="form-control" name="name" id="m-name" placeholder="物料名称" required>
                        </div>
                    </div>
                </div>
                <br>
                <div class="row" style="margin-top: 20px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-3" style="margin-top: -8px;margin-left: -60px;">
                            <input type="text" class="form-control" name="type" id="m-type" placeholder="物料类型" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="m-price" class="col-md-2 control-label" style="margin-top: -15px;margin-left: 60px;">物料价格</label>
                        <div class="col-md-3" style="margin-top: -23px;margin-left: -60px;">
                            <input type="text" class="form-control" name="price" id="m-price" placeholder="物料价格" required>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-top: 40px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-3" style="margin-top: -8px;margin-left: -60px;">
                            <input type="text" class="form-control" name="stock" id="m-stock" placeholder="当前库存" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="m-sstock" class="col-md-2 control-label" style="margin-top: -15px;margin-left: 60px;">安全库存</label>
                        <div class="col-md-3" style="margin-top: -23px;margin-left: -60px;">
                            <input type="text" class="form-control" name="sstock" id="m-sstock" placeholder="安全库存" required>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-top: 20px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-8" style="margin-top: 12px;margin-left: -60px;">
                            <input type="text" class="form-control" name="describe" id="m-describe" placeholder="物料描述">
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-top: 40px;">
