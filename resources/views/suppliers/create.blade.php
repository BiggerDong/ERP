                ...
                <form action="/suppliers" method="post">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="form-group">
                            ...
                            <div class="col-md-3" style="margin-top: -8px;margin-left: -60px;">
                                <input type="text" class="form-control" name="sid" id="s-number" placeholder="供应商编号" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3" style="margin-top: -23px;margin-left: -60px;">
                                <input type="text" class="form-control" name="name" id="s-name" placeholder="供应商名称" required>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row" style="margin-top: 20px;">
                        <div class="form-group">
                            ...
                            <div class="col-md-3" style="margin-top: -8px;margin-left: -60px;">
                                <input type="text" class="form-control" name="phone" id="m-phone" placeholder="供应商电话" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="m-address" class="col-md-2 control-label" style="margin-top: -15px;margin-left: 60px;">供应商地址</label>
                            <div class="col-md-3" style="margin-top: -23px;margin-left: -60px;">
                                <input type="text" class="form-control" name="address" id="m-address" placeholder="供应商地址" required>
                            </div>
                        </div>
                    </div>
